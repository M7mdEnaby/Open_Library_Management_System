...
void BookManager::FetchBookList(const std::string& name, const std::string& author, const std::string& year) {
    ...
    listFetcher = std::make_unique<BookListFetcher>(name, author, year);
